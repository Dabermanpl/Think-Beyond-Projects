...
const BannerV2 = React.forwardRef<HTMLDivElement>((_, ref) => (
    <div ref={ref} className="banner v2">
        <div className="v8-orb v8-orb1"></div>
        <div className="v8-orb v8-orb2"></div>
        <div className="v8-scanline"></div>
